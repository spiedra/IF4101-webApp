...
ALTER PROCEDURE ADMINISTRACION.sp_CONFIRMAR_RESERVA
	@param_ID_ESTANCIA INT,
...
ALTER PROCEDURE ADMINISTRACION.sp_GET_RESERVAS_CONFIRMADAS
AS
BEGIN
	SELECT
	
	
	 R.[ID], E.[NOMBRE], c.[CEDULA], [NOMBRE_COMPLETO], [TELEFONO_CONTACTO], [CANTIDAD_PERSONAS], [FECHA_ENTRADA], [FECHA_SALIDA], [PROVINCIA]
	FROM [ADMINISTRACION].[tb_RESERVA] R
		JOIN [CLIENTES].[tb_CLIENTE] C
			ON R.[ID_CLIENTE] = c.ID
			JOIN [ADMINISTRACION].[tb_ESTADIA] E
				ON E.ID = R.[ID_ESTADIA]
END
GO